...
_VARIANT.fields_by_name['entityid_value'].message_type = bnet_dot_entity__pb2._ENTITYID
...
AttributeFilter = _reflection.GeneratedProtocolMessageType('AttributeFilter', (_message.Message,), {
