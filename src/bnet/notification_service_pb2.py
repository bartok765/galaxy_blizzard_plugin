...
_NOTIFICATION.fields_by_name['sender_id'].message_type = bnet_dot_entity__pb2._ENTITYID
_NOTIFICATION.fields_by_name['target_id'].message_type = bnet_dot_entity__pb2._ENTITYID
_NOTIFICATION.fields_by_name['attribute'].message_type = bnet_dot_attribute__pb2._ATTRIBUTE
_NOTIFICATION.fields_by_name['sender_account_id'].message_type = bnet_dot_entity__pb2._ENTITYID
...
_FINDCLIENTRESPONSE.fields_by_name['client_process_id'].message_type = bnet_dot_rpc__pb2._PROCESSID
_REGISTERCLIENTREQUEST.fields_by_name['entity_id'].message_type = bnet_dot_entity__pb2._ENTITYID
...
FindClientRequest = _reflection.GeneratedProtocolMessageType('FindClientRequest', (_message.Message,), {
...
FindClientResponse = _reflection.GeneratedProtocolMessageType('FindClientResponse', (_message.Message,), {
