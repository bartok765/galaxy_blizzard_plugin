...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[bnet.content_handle_pb2.DESCRIPTOR,bnet.rpc_pb2.DESCRIPTOR,])
...
_CONNECTREQUEST.fields_by_name['client_id'].message_type = bnet.rpc_pb2._PROCESSID
_CONNECTREQUEST.fields_by_name['bind_request'].message_type = _BINDREQUEST
_CONNECTIONMETERINGCONTENTHANDLES.fields_by_name['content_handle'].message_type = bnet.content_handle_pb2._CONTENTHANDLE
_CONNECTRESPONSE.fields_by_name['server_id'].message_type = bnet.rpc_pb2._PROCESSID
_CONNECTRESPONSE.fields_by_name['client_id'].message_type = bnet.rpc_pb2._PROCESSID
...
_BINDRESPONSE.fields_by_name['imported_service_id'].has_options = True
_BINDRESPONSE.fields_by_name['imported_service_id']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
