...
_GAMESTATSBUCKET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      has_default_value=True, default_value=float(4.29496704e+09),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
_PLAYER.fields_by_name['identity'].message_type = bnet_dot_entity__pb2._IDENTITY
_PLAYER.fields_by_name['attribute'].message_type = bnet_dot_attribute__pb2._ATTRIBUTE
_CONNECTINFO.fields_by_name['member_id'].message_type = bnet_dot_entity__pb2._ENTITYID
_CONNECTINFO.fields_by_name['attribute'].message_type = bnet_dot_attribute__pb2._ATTRIBUTE
_GAMEFACTORYDESCRIPTION.fields_by_name['attribute'].message_type = bnet_dot_attribute__pb2._ATTRIBUTE
_GAMEFACTORYDESCRIPTION.fields_by_name['stats_bucket'].message_type = _GAMESTATSBUCKET
_GAMEHANDLE.fields_by_name['game_id'].message_type = bnet_dot_entity__pb2._ENTITYID
...
GameStatsBucket = _reflection.GeneratedProtocolMessageType('GameStatsBucket', (_message.Message,), {
...
GameFactoryDescription = _reflection.GeneratedProtocolMessageType('GameFactoryDescription', (_message.Message,), {
...
GameHandle = _reflection.GeneratedProtocolMessageType('GameHandle', (_message.Message,), {
...
CancelGameEntryRequest = _reflection.GeneratedProtocolMessageType('CancelGameEntryRequest', (_message.Message,), {
