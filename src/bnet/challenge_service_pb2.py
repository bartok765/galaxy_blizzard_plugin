...
_SENDCHALLENGETOUSERREQUEST.fields_by_name['peer_id'].message_type = bnet.rpc_pb2._PROCESSID
_SENDCHALLENGETOUSERREQUEST.fields_by_name['game_account_id'].message_type = bnet.entity_pb2._ENTITYID
_SENDCHALLENGETOUSERREQUEST.fields_by_name['challenges'].message_type = _CHALLENGE
_SENDCHALLENGETOUSERREQUEST.fields_by_name['attributes'].message_type = bnet.attribute_pb2._ATTRIBUTE
_CHALLENGEUSERREQUEST.fields_by_name['challenges'].message_type = _CHALLENGE
_CHALLENGEUSERREQUEST.fields_by_name['attributes'].message_type = bnet.attribute_pb2._ATTRIBUTE
_CHALLENGEUSERREQUEST.fields_by_name['game_account_id'].message_type = bnet.entity_pb2._ENTITYID
