...
RPCMethodConfig = _reflection.GeneratedProtocolMessageType('RPCMethodConfig', (_message.Message,), {
...
RPCMeterConfig = _reflection.GeneratedProtocolMessageType('RPCMeterConfig', (_message.Message,), {
