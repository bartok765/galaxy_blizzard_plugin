...
_GAMEPROPERTIES.fields_by_name['creation_attributes'].message_type = bnet_dot_attribute__pb2._ATTRIBUTE
_GAMEPROPERTIES.fields_by_name['filter'].message_type = bnet_dot_attribute__pb2._ATTRIBUTEFILTER
