...
_INVITATION.fields_by_name['inviter_identity'].message_type = bnet_dot_entity__pb2._IDENTITY
_INVITATION.fields_by_name['invitee_identity'].message_type = bnet_dot_entity__pb2._IDENTITY
_SUGGESTION.fields_by_name['channel_id'].message_type = bnet_dot_entity__pb2._ENTITYID
_SUGGESTION.fields_by_name['suggester_id'].message_type = bnet_dot_entity__pb2._ENTITYID
_SUGGESTION.fields_by_name['suggestee_id'].message_type = bnet_dot_entity__pb2._ENTITYID
_SUGGESTION.fields_by_name['suggester_account_id'].message_type = bnet_dot_entity__pb2._ENTITYID
_INVITATIONTARGET.fields_by_name['identity'].message_type = bnet_dot_entity__pb2._IDENTITY
_SENDINVITATIONREQUEST.fields_by_name['agent_identity'].message_type = bnet_dot_entity__pb2._IDENTITY
_SENDINVITATIONREQUEST.fields_by_name['target_id'].message_type = bnet_dot_entity__pb2._ENTITYID
_SENDINVITATIONREQUEST.fields_by_name['params'].message_type = _INVITATIONPARAMS
_SENDINVITATIONREQUEST.fields_by_name['agent_info'].message_type = bnet_dot_entity__pb2._ACCOUNTINFO
...
_UPDATEINVITATIONREQUEST.fields_by_name['agent_identity'].message_type = bnet_dot_entity__pb2._IDENTITY
_UPDATEINVITATIONREQUEST.fields_by_name['params'].message_type = _INVITATIONPARAMS
_GENERICREQUEST.fields_by_name['agent_id'].message_type = bnet_dot_entity__pb2._ENTITYID
...
InvitationTarget = _reflection.GeneratedProtocolMessageType('InvitationTarget', (_message.Message,), {
...
InvitationParams = _reflection.GeneratedProtocolMessageType('InvitationParams', (_message.Message,), {
...
_GENERICREQUEST.fields_by_name['previous_role']._options = None
_GENERICREQUEST.fields_by_name['desired_role']._options = None
