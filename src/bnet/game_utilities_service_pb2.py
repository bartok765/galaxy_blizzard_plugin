...
from bnet import game_utilities_types_pb2 as bnet_dot_game__utilities__types__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[bnet_dot_attribute__pb2.DESCRIPTOR,bnet_dot_entity__pb2.DESCRIPTOR,bnet_dot_game__utilities__types__pb2.DESCRIPTOR,bnet_dot_rpc__pb2.DESCRIPTOR,])
...
_CLIENTREQUEST.fields_by_name['attribute'].message_type = bnet_dot_attribute__pb2._ATTRIBUTE
_CLIENTREQUEST.fields_by_name['host'].message_type = bnet_dot_rpc__pb2._PROCESSID
_CLIENTREQUEST.fields_by_name['bnet_account_id'].message_type = bnet_dot_entity__pb2._ENTITYID
_CLIENTREQUEST.fields_by_name['game_account_id'].message_type = bnet_dot_entity__pb2._ENTITYID
_CLIENTRESPONSE.fields_by_name['attribute'].message_type = bnet_dot_attribute__pb2._ATTRIBUTE
_SERVERREQUEST.fields_by_name['attribute'].message_type = bnet_dot_attribute__pb2._ATTRIBUTE
_SERVERREQUEST.fields_by_name['host'].message_type = bnet_dot_rpc__pb2._PROCESSID
_SERVERRESPONSE.fields_by_name['attribute'].message_type = bnet_dot_attribute__pb2._ATTRIBUTE
_PRESENCECHANNELCREATEDREQUEST.fields_by_name['id'].message_type = bnet_dot_entity__pb2._ENTITYID
_PRESENCECHANNELCREATEDREQUEST.fields_by_name['game_account_id'].message_type = bnet_dot_entity__pb2._ENTITYID
_PRESENCECHANNELCREATEDREQUEST.fields_by_name['bnet_account_id'].message_type = bnet_dot_entity__pb2._ENTITYID
_PRESENCECHANNELCREATEDREQUEST.fields_by_name['host'].message_type = bnet_dot_rpc__pb2._PROCESSID
_GETPLAYERVARIABLESREQUEST.fields_by_name['player_variables'].message_type = bnet_dot_game__utilities__types__pb2._PLAYERVARIABLES
_GETPLAYERVARIABLESREQUEST.fields_by_name['host'].message_type = bnet_dot_rpc__pb2._PROCESSID
_GETPLAYERVARIABLESRESPONSE.fields_by_name['player_variables'].message_type = bnet_dot_game__utilities__types__pb2._PLAYERVARIABLES
_GAMEACCOUNTONLINENOTIFICATION.fields_by_name['game_account_id'].message_type = bnet_dot_entity__pb2._ENTITYID
_GAMEACCOUNTONLINENOTIFICATION.fields_by_name['host'].message_type = bnet_dot_rpc__pb2._PROCESSID
_GAMEACCOUNTOFFLINENOTIFICATION.fields_by_name['game_account_id'].message_type = bnet_dot_entity__pb2._ENTITYID
_GAMEACCOUNTOFFLINENOTIFICATION.fields_by_name['host'].message_type = bnet_dot_rpc__pb2._PROCESSID
...
PresenceChannelCreatedRequest = _reflection.GeneratedProtocolMessageType('PresenceChannelCreatedRequest', (_message.Message,), {
...
GetPlayerVariablesRequest = _reflection.GeneratedProtocolMessageType('GetPlayerVariablesRequest', (_message.Message,), {
...
GetPlayerVariablesResponse = _reflection.GeneratedProtocolMessageType('GetPlayerVariablesResponse', (_message.Message,), {
...
GameAccountOnlineNotification = _reflection.GeneratedProtocolMessageType('GameAccountOnlineNotification', (_message.Message,), {
...
GameAccountOfflineNotification = _reflection.GeneratedProtocolMessageType('GameAccountOfflineNotification', (_message.Message,), {
